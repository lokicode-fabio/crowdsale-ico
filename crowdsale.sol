...
contract CFTcoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function CFTcoin() {
        ...
        name = "Loki Linea Token";                                            // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "LLT";                                             // Set the symbol for display purposes (CHANGE THIS)
        unitsOneEthCanBuy = 50;                                      // Set the price of your token for the ICO (CHANGE THIS)
        fundsWallet = msg.sender;                                    // The owner of the contract gets ETH
    }


    // contract to allow eth
    function() payable{
